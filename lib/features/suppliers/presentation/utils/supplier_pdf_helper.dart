      ...
      pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Text('فاتورة مشتريات / توريد - بسيط', style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold, color: PdfColors.teal900)),
              pw.Text('BASEET POS - PURCHASE INVOICE', style: const pw.TextStyle(fontSize: 12, color: PdfColors.grey700)),
              ...
              pw.Align(
                ...
                child: pw.Text(StringsManager.suppliersPurchasedGoods.lang, style: pw.TextStyle(fontSize: 15, fontWeight: pw.FontWeight.bold)),
              ),
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('${StringsManager.posTotal.lang}:', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
                  pw.Text('${invoice.totalAmount.toStringAsFixed(0)} ${StringsManager.posCurrency.lang}', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold, color: PdfColors.teal900)),
                ],
              ),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
      ...
      pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Column(
            crossAxisAlignment: pw.CrossAxisAlignment.center,
            children: [
              pw.Text('كشف حساب وفواتير المورد - بسيط', style: pw.TextStyle(fontSize: 22, fontWeight: pw.FontWeight.bold, color: PdfColors.teal900)),
              pw.Text('BASEET POS - SUPPLIER STATEMENT', style: const pw.TextStyle(fontSize: 12, color: PdfColors.grey700)),
              pw.SizedBox(height: AppSpacing.md),
              pw.Divider(thickness: 1.5, color: PdfColors.teal900),
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
              ...
              pw.Align(
                alignment: pw.Alignment.centerRight,
                child: pw.Text('${StringsManager.suppliersInvoicesHistory.lang} (${invoices.length})', style: pw.TextStyle(fontSize: 15, fontWeight: pw.FontWeight.bold)),
              ),
              pw.SizedBox(height: AppSpacing.sm),
